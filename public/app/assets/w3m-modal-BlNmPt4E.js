import{ab as k,bf as le,R as c,C as pe,c as v,r as V,a as f,i as g,b as d,n as l,a1 as $,A as H,a2 as u,e as me,k as w,v as B,$ as U,bb as fe,ah as F,E as K,a5 as A,s as M,g as we,S as E,ad as z,b8 as oe,a0 as be,U as ce,bg as ge,bh as ye}from"./index-CUngDqPp.js";import{P as D}from"./index-D4quMFyF.js";import{S as ve}from"./SwapController-CT6WxrPa.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
