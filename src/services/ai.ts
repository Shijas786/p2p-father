...
2. CREATE_BUY_ORDER — User wants to buy crypto (e.g., "buy 10 USDT for 100", "i want to buy 10 usdt for 100"). Params: { amount, token, rate, chain }
