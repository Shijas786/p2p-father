...
const envSchema = z.object({
    ...
    BASE_RPC_URL: z.string().default("https://base-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    BSC_RPC_URL: z.string().default("https://bnb-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    POLYGON_RPC_URL: z.string().default("https://polygon-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    MAINNET_RPC_URL: z.string().default("https://eth-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    ARBITRUM_RPC_URL: z.string().default("https://arb-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    OPTIMISM_RPC_URL: z.string().default("https://opt-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    AVALANCHE_RPC_URL: z.string().default("https://avax-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    LINEA_RPC_URL: z.string().default("https://linea-mainnet.g.alchemy.com/v2/alch_REDACTED"),
    SCROLL_RPC_URL: z.string().default("https://scroll-mainnet.g.alchemy.com/v2/alch_REDACTED"),
