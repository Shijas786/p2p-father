...
const envSchema = z.object({
    ...
    POLYGON_RPC_URL: z.string().default("https://polygon.publicnode.com"),
    ...
    LINEA_RPC_URL: z.string().default("https://rpc.linea.build"),
    SCROLL_RPC_URL: z.string().default("https://rpc.scroll.io"),
